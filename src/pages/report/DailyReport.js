        ...
        <Layout>
            <div className="bg-secondary pl-5 pr-2 pb-3 w-[84vw]">
                <div className="flex items-center gap-2">
                    <h1 className="text-xl py-3 font-semibold">Laporan Penjual</h1>
                </div>
                                            ...
                                            {error ?  
                                                    ...
                                                    <tr key={item.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                        ...
                                                        <td className="py-4 px-6 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                            <Link to={`/laporan/harian/${item.id}/${item.company}`}>
                                                                {item.company}
                                                            </Link>
                                                        </td>
                                                        <td className="py-4 px-6 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                        ...
                                                        <td className="py-4 px-6 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                                <div className="flex gap-3">
                                                                    <Link to={`/laporan/harian/${item.id}/${item.company}`}><BsBoxArrowInDownRight className="text-button" /></Link>
                                                                </div>
                                                         </td>
                                                    </tr>
                                                ))}
