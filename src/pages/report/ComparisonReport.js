...
const ComparisonReport = () => {
    ...
    const {data, isLoading, error} = useFetch(`/orders/report/comparison?startDate=${startDate}&endDate=${endDate}`);
    
    
    const handleDownloadFile = () => {
        fetchReport(`/orders/report/generateComparison?startDate=${startDate}&endDate=${endDate}`);
    }
    ...
    return ( 
        <Layout>
            <div className="bg-secondary pl-5 pr-2 pb-3 w-[84vw]">
                <h1 className="text-xl py-3">Data Pembanding Transaksi</h1>
